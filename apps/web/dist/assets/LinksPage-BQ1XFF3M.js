import{c as C,r as l,j as e,Z as k,i as o,h as D,E as I,g as w,k as y,L as j,e as B}from"./index-Dxh3r0nY.js";/* empty css                          */import{E as v}from"./eye-off-CiKrOiv8.js";import{C as N}from"./copy-C9V9IgkZ.js";import{T as z}from"./trash-2-sbawX-tY.js";import{S as O}from"./shield-8O9fNG3u.js";/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const X=[["path",{d:"M10 20a1 1 0 0 0 .553.895l2 1A1 1 0 0 0 14 21v-7a2 2 0 0 1 .517-1.341L21.74 4.67A1 1 0 0 0 21 3H3a1 1 0 0 0-.742 1.67l7.225 7.989A2 2 0 0 1 10 14z",key:"sc7q7i"}]],q=C("funnel",X);/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const H=[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]],P=C("search",H);function Q(){const[L,p]=l.useState([]),[E,c]=l.useState(!0),[d,A]=l.useState(""),[S,R]=l.useState(0),x=l.useRef(0),g=async()=>{c(!0);try{const a=await j.getAll();p(a)}catch(a){console.error(a)}finally{c(!1)}};l.useEffect(()=>{g()},[]);const b=async a=>{if(window.confirm("¿Eliminar enlace?"))try{await j.deleteLink(a),p(i=>i.filter(s=>s.id!==a))}catch{alert("Error al eliminar.")}},m=a=>{navigator.clipboard.writeText(`${window.location.origin}/l/${a}`),alert("Copiado")},r=L.filter(a=>{var s;const i=d.toLowerCase();return((s=a.slug)==null?void 0:s.toLowerCase().includes(i))||a.original_url.toLowerCase().includes(i)}),f=r.length;l.useEffect(()=>{const a=x.current,i=f;if(a===i)return;const s=i-a,F=480,T=performance.now();let t;const u=_=>{const n=Math.min((_-T)/F,1),M=n<.5?2*n*n:-1+(4-2*n)*n,Y=Math.round(a+s*M);R(Y),n<1?t=requestAnimationFrame(u):x.current=i};return t=requestAnimationFrame(u),()=>cancelAnimationFrame(t)},[f]);const h=a=>{const i={lite:{bg:"rgba(16,185,129,0.16)",color:"#6EE7B7",border:"rgba(16,185,129,0.7)",icon:e.jsx(O,{size:12})},standard:{bg:"rgba(59,130,246,0.18)",color:"#BFDBFE",border:"rgba(59,130,246,0.7)",icon:e.jsx(k,{size:12})},turbo:{bg:"rgba(249,115,22,0.16)",color:"#FED7AA",border:"rgba(249,115,22,0.7)",icon:e.jsx(B,{size:12})}},s=i[a]||i.standard;return e.jsxs("span",{className:"lp-links-mode",style:{background:s.bg,color:s.color,borderColor:s.border},children:[s.icon,a]})};return e.jsxs("div",{className:"lp-links-shell lp-premium-bg",children:[e.jsx("style",{children:V}),e.jsxs("div",{className:"lp-links-inner lp-premium-inner",children:[e.jsxs("section",{className:"lp-links-card lp-links-card-filters",children:[e.jsxs("div",{className:"lp-links-filters-row",children:[e.jsxs("div",{className:"lp-links-search",children:[e.jsx(P,{className:"lp-links-search-icon",size:16}),e.jsx("input",{placeholder:"Buscar por slug o URL…",value:d,onChange:a=>A(a.target.value)})]}),e.jsxs("button",{type:"button",onClick:g,className:"lp-links-refresh",children:[e.jsx(k,{size:16}),"Refrescar"]})]}),e.jsxs("div",{className:"lp-links-meta",children:[e.jsxs("span",{className:"lp-links-count",children:[e.jsx("span",{className:"lp-links-count-glow"}),e.jsx("strong",{children:S}),e.jsx("span",{className:"lp-links-count-label",children:"enlaces visibles"})]}),e.jsxs("span",{className:"lp-links-meta-pill",children:[e.jsx(q,{size:12}),"Filtro instantáneo"]})]})]}),e.jsxs("section",{className:"lp-links-card lp-links-card-main",children:[e.jsxs("div",{className:"lp-links-card-header",children:[e.jsx("div",{className:"lp-links-card-icon",children:e.jsx(o,{size:18})}),e.jsxs("div",{className:"lp-links-card-title",children:[e.jsx("h3",{children:"Todos tus enlaces"}),e.jsx("p",{children:"Vista avanzada con visitas, revenue y modo de monetización de cada Smart Link."})]})]}),E?e.jsxs("div",{className:"lp-links-loading",children:[e.jsx("div",{className:"lp-links-orb",children:e.jsx(D,{size:22,className:"spin"})}),e.jsx("p",{children:"Cargando enlaces…"})]}):r.length===0?e.jsxs("div",{className:"lp-links-empty",children:[e.jsx("div",{className:"lp-links-empty-icon",children:e.jsx(I,{size:24})}),e.jsx("p",{className:"lp-links-empty-title",children:"No hay enlaces aún."}),e.jsxs("p",{className:"lp-links-empty-sub",children:["Crea tu primer Smart Link desde la pestaña ",e.jsx("strong",{children:"Crear Link"}),"."]})]}):e.jsxs("div",{className:"lp-links-table-wrapper",children:[e.jsxs("table",{className:"lp-links-table lp-desktop-only",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Enlace"}),e.jsx("th",{children:"Modo"}),e.jsx("th",{children:"Visitas"}),e.jsx("th",{children:"Revenue"}),e.jsx("th",{className:"lp-th-right",children:"Acciones"})]})}),e.jsx("tbody",{children:r.map(a=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsxs("div",{className:"lp-link-main",children:[e.jsxs("div",{className:"lp-link-slug-row",children:[e.jsxs("span",{className:"lp-link-slug",children:["/",a.slug]}),a.password&&e.jsx(w,{size:12,className:"lp-link-flag lp-link-flag-orange"}),a.expires_at&&e.jsx(y,{size:12,className:"lp-link-flag lp-link-flag-red"}),a.is_private&&e.jsx(v,{size:12,className:"lp-link-flag lp-link-flag-purple"})]}),e.jsx("span",{className:"lp-link-url",children:a.original_url})]})}),e.jsx("td",{children:h(a.monetization_mode||"standard")}),e.jsx("td",{children:e.jsxs("div",{className:"lp-link-visits",children:[e.jsx(o,{size:15}),a.views]})}),e.jsx("td",{children:e.jsxs("div",{className:"lp-link-revenue",children:["€",(a.earnings||0).toFixed(4)]})}),e.jsx("td",{className:"lp-td-right",children:e.jsxs("div",{className:"lp-link-actions",children:[e.jsx("button",{type:"button",onClick:()=>m(a.slug),className:"lp-btn-ghost",children:e.jsx(N,{size:15})}),e.jsx("button",{type:"button",onClick:()=>b(a.id),className:"lp-btn-danger",children:e.jsx(z,{size:15})})]})})]},a.id))})]}),e.jsx("div",{className:"lp-links-list lp-mobile-only",children:r.map(a=>e.jsxs("div",{className:"lp-link-card",children:[e.jsxs("div",{className:"lp-link-card-top",children:[e.jsxs("div",{className:"lp-link-card-main",children:[e.jsxs("div",{className:"lp-link-slug-row",children:[e.jsxs("span",{className:"lp-link-slug",children:["/",a.slug]}),a.password&&e.jsx(w,{size:11,className:"lp-link-flag lp-link-flag-orange"}),a.expires_at&&e.jsx(y,{size:11,className:"lp-link-flag lp-link-flag-red"}),a.is_private&&e.jsx(v,{size:11,className:"lp-link-flag lp-link-flag-purple"})]}),e.jsx("span",{className:"lp-link-url lp-link-url-mobile",children:a.original_url})]}),e.jsx("div",{className:"lp-link-card-mode",children:h(a.monetization_mode||"standard")})]}),e.jsxs("div",{className:"lp-link-card-bottom",children:[e.jsxs("div",{className:"lp-link-card-stats",children:[e.jsxs("span",{className:"lp-chip-stat",children:[e.jsx(o,{size:12}),a.views," visitas"]}),e.jsxs("span",{className:"lp-chip-money",children:["€",(a.earnings||0).toFixed(4)]})]}),e.jsxs("div",{className:"lp-link-card-actions",children:[e.jsx("button",{type:"button",onClick:()=>m(a.slug),className:"lp-btn-ghost",children:e.jsx(N,{size:14})}),e.jsx("button",{type:"button",onClick:()=>b(a.id),className:"lp-btn-danger",children:e.jsx(z,{size:14})})]})]})]},a.id))})]})]})]})]})}const V=`
  .spin {
