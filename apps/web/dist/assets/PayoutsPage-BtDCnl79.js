import{d as v,B as ce,r,j as e,l as P,X as G,D as d,F as xe,k as K,G as X,P as J}from"./index-BDb2tGRn.js";import{P as me}from"./PremiumLoader-svAKplen.js";/* empty css                          *//**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ge=[["path",{d:"M17 7 7 17",key:"15tmo1"}],["path",{d:"M17 17H7V7",key:"1org7z"}]],A=v("arrow-down-left",ge);/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ve=[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]],u=v("send",ve),C={isValidEmail:n=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(n),isValidIBAN:n=>{const o=n.replace(/\s/g,"").toUpperCase();return o.length<15||o.length>34||!/^[A-Z]{2}/.test(o)?!1:/^[A-Z0-9]+$/.test(o)},isValidCrypto:n=>{const o=/^0x[a-fA-F0-9]{40}$/.test(n),y=/^(1|3|bc1)[a-zA-Z0-9]{25,39}$/.test(n);return o||y}};function ke(){const{balance:n,history:o,loading:y,refresh:M}=ce(),[Q,x]=r.useState(!1),[ee,m]=r.useState(!1),[w,I]=r.useState(""),[t,L]=r.useState("PayPal"),[g,f]=r.useState(""),[ae,re]=r.useState(""),[O,l]=r.useState(""),[R,T]=r.useState(!1),[j,N]=r.useState(!1),[B,D]=r.useState(""),[b,F]=r.useState(""),[k,_]=r.useState(""),[te,W]=r.useState(""),[U,p]=r.useState(""),[$,H]=r.useState(!1),[z,S]=r.useState(!1),[c,ie]=r.useState({paypal:"",bank:""}),[E,ne]=r.useState(10),oe=10,V=5,Y=10,q=t==="PayPal"?V:Y;r.useEffect(()=>{(async()=>{const{data:{user:i}}=await X.auth.getUser();if(i){const{data:s}=await X.from("profiles").select("paypal_email, bank_details").eq("id",i.id).single();s&&(ie({paypal:s.paypal_email||"",bank:s.bank_details||""}),s.paypal_email&&f(s.paypal_email))}})()},[]),r.useEffect(()=>{t==="PayPal"&&c.paypal&&f(c.paypal),t==="Bank"&&c.bank&&f(c.bank)},[t,c]);const se=async()=>{l(""),N(!1);const a=parseFloat(w);if(!w||isNaN(a)||a<=0)return l("Introduce una cantidad válida.");if(a>n)return l("Saldo insuficiente.");if(a<q)return l(`Mínimo ${t==="PayPal"?"PayPal":"transferencia"}: €${q}`);if(t==="PayPal"){if(!C.isValidEmail(g))return l("Introduce un email de PayPal válido.")}else if(!C.isValidIBAN(g))return l("Introduce un IBAN válido.");T(!0);try{await J.requestPayout(a,t,g),N(!0),D("¡Listo! Tu solicitud está en proceso."),I(""),M(),setTimeout(()=>{N(!1),x(!1),D("")},2400)}catch(i){l(i.message||"Error al procesar el retiro.")}finally{T(!1)}},le=async()=>{p(""),S(!1);const a=parseFloat(k);if(!b||!C.isValidEmail(b))return p("Introduce un email válido.");if(!k||isNaN(a)||a<=0)return p("Introduce una cantidad válida.");if(a>n)return p("Saldo insuficiente.");H(!0);try{await J.sendMoney(b,a),S(!0),_(""),F(""),W(""),M(),setTimeout(()=>{S(!1),m(!1)},2e3)}catch(i){p(i.message||"Error al enviar.")}finally{H(!1)}};return y?e.jsx(me,{size:"medium",text:"FINANZAS",subtext:"Cargando tu billetera..."}):e.jsxs("div",{className:"rev-shell lp-premium-bg",style:{position:"fixed",inset:0,left:window.innerWidth>768?"260px":0,display:"flex",flexDirection:"column",overflow:"hidden"},children:[e.jsx("style",{children:ye}),e.jsxs("div",{className:"rev-bg",children:[e.jsx("div",{className:"rev-bg-gradient"}),e.jsx("div",{className:"rev-bg-glow"})]}),e.jsxs("div",{style:{position:"relative",zIndex:1,display:"flex",flexDirection:"column",height:"100%",paddingTop:window.innerWidth<=768?"60px":"20px",paddingBottom:window.innerWidth<=768?"90px":"20px",overflow:"hidden"},children:[e.jsx("section",{style:{padding:window.innerWidth<=768?"20px 0 16px":"40px 0 24px",textAlign:"center",flexShrink:0},children:e.jsxs("div",{className:"rev-balance-card",children:[e.jsx("span",{className:"rev-balance-label",children:"LinkPay · EUR"}),e.jsxs("div",{className:"rev-balance-amount",children:[e.jsx("span",{className:"rev-amount-value",children:n.toFixed(2).split(".")[0]}),e.jsxs("span",{className:"rev-amount-decimal",children:[",",n.toFixed(2).split(".")[1]," €"]})]})]})}),e.jsxs("section",{style:{display:"flex",justifyContent:"center",gap:"24px",padding:window.innerWidth<=768?"8px 0 20px":"16px 0 28px",flexShrink:0},children:[e.jsxs("button",{className:"rev-action-item",onClick:()=>x(!0),children:[e.jsx("div",{className:"rev-action-circle",children:e.jsx(A,{size:22})}),e.jsx("span",{children:"Solicitar retiro"})]}),e.jsxs("button",{className:"rev-action-item",onClick:()=>m(!0),children:[e.jsx("div",{className:"rev-action-circle",children:e.jsx(u,{size:22})}),e.jsx("span",{children:"Enviar interno"})]})]}),e.jsxs("section",{style:{flex:1,background:"rgba(15, 23, 42, 0.9)",borderRadius:"24px 24px 0 0",padding:"20px 16px 40px",margin:"0 -12px",overflowY:"auto",WebkitOverflowScrolling:"touch",borderTop:"1px solid rgba(255, 255, 255, 0.1)"},onScroll:a=>{const i=a.target;i.scrollHeight-i.scrollTop-i.clientHeight<100&&E<o.length&&ne(h=>Math.min(h+oe,o.length))},children:[e.jsx("h3",{className:"rev-section-title",children:"Actividad reciente"}),o.length===0?e.jsxs("div",{className:"rev-empty",children:[e.jsx(ue,{size:32}),e.jsx("p",{children:"Sin movimientos aún"}),e.jsx("span",{children:"Tus transacciones aparecerán aquí"})]}):e.jsxs("div",{className:"rev-tx-list",children:[o.slice(0,E).map(a=>{const i=a.is_negative,s=a.type==="withdrawal"?"Retiro":i?"Envío":"Recibido",h=["#22c55e","#3b82f6","#f59e0b","#ef4444","#8b5cf6","#ec4899"],de=a.id.charCodeAt(0)%h.length,pe=h[de],Z=a.status==="pending"?"Pendiente":a.status==="failed"?"Rechazado":"";return e.jsxs("div",{className:"rev-tx-item",children:[e.jsxs("div",{className:"rev-tx-left",children:[e.jsx("div",{className:"rev-tx-avatar",style:{background:pe},children:a.type==="withdrawal"?e.jsx(A,{size:18,color:"#fff"}):e.jsx(u,{size:18,color:"#fff"})}),e.jsxs("div",{className:"rev-tx-info",children:[e.jsx("span",{className:"rev-tx-name",children:s}),e.jsx("span",{className:"rev-tx-date",children:a.date})]})]}),e.jsxs("div",{className:"rev-tx-right",children:[e.jsxs("span",{className:`rev-tx-amount ${i?"negative":"positive"}`,children:[i?"-":"+",Number(a.amount).toFixed(2)," €"]}),Z&&e.jsx("span",{className:`rev-tx-status ${a.status}`,children:Z})]})]},a.id)}),E<o.length&&e.jsx("div",{className:"rev-tx-loading",children:e.jsx(P,{size:20,className:"rev-spin"})})]})]})]}),Q&&e.jsx("div",{className:"lp-modal-overlay",onClick:()=>x(!1),children:e.jsxs("div",{className:"lp-modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"lp-modal-header",children:[e.jsx("button",{className:"lp-modal-close",onClick:()=>x(!1),children:e.jsx(G,{size:22})}),e.jsx("div",{className:"lp-modal-icon withdraw",children:e.jsx(A,{size:28})}),e.jsx("h2",{children:"Retirar fondos"}),e.jsx("p",{className:"lp-modal-subtitle",children:"Recibe tu dinero en PayPal o cuenta bancaria"})]}),e.jsxs("div",{className:"lp-modal-body",children:[e.jsxs("div",{className:"lp-amount-hero",children:[e.jsxs("div",{className:"lp-amount-row",children:[e.jsx("input",{type:"number",inputMode:"decimal",value:w,onChange:a=>I(a.target.value),placeholder:"0",className:"lp-amount-input"}),e.jsx("span",{className:"lp-amount-currency",children:"EUR"})]}),e.jsxs("div",{className:"lp-amount-available",children:["Disponible: ",e.jsxs("strong",{children:[n.toFixed(2)," €"]})]})]}),B&&e.jsxs("div",{className:"lp-success-banner",children:[e.jsx(d,{size:20}),e.jsx("span",{children:B})]}),e.jsxs("div",{className:"lp-field",children:[e.jsx("label",{children:"Método de pago"}),e.jsxs("div",{className:"lp-method-grid",children:[e.jsxs("button",{className:`lp-method-card ${t==="PayPal"?"active":""}`,onClick:()=>L("PayPal"),children:[e.jsx("div",{className:"lp-method-icon paypal",children:e.jsx(xe,{size:20})}),e.jsxs("div",{className:"lp-method-info",children:[e.jsx("span",{className:"lp-method-name",children:"PayPal"}),e.jsxs("span",{className:"lp-method-min",children:["Mín. ",V,"€"]})]}),t==="PayPal"&&e.jsx(d,{size:18,className:"lp-method-check"})]}),e.jsxs("button",{className:`lp-method-card ${t==="Bank"?"active":""}`,onClick:()=>L("Bank"),children:[e.jsx("div",{className:"lp-method-icon bank",children:e.jsx(be,{size:20})}),e.jsxs("div",{className:"lp-method-info",children:[e.jsx("span",{className:"lp-method-name",children:"Transferencia"}),e.jsxs("span",{className:"lp-method-min",children:["Mín. ",Y,"€"]})]}),t==="Bank"&&e.jsx(d,{size:18,className:"lp-method-check"})]})]})]}),e.jsxs("div",{className:"lp-field",children:[e.jsx("label",{children:t==="PayPal"?"Email de PayPal":"Número IBAN"}),e.jsx("input",{type:t==="PayPal"?"email":"text",value:g,onChange:a=>f(t==="Bank"?a.target.value.toUpperCase():a.target.value),placeholder:t==="PayPal"?"tu@email.com":"ES00 0000 0000 0000 0000 0000",className:"lp-input"})]}),t==="Bank"&&e.jsxs("div",{className:"lp-field",children:[e.jsx("label",{children:"Titular de la cuenta"}),e.jsx("input",{type:"text",value:ae,onChange:a=>re(a.target.value),placeholder:"Nombre y apellidos",className:"lp-input"})]}),O&&e.jsxs("div",{className:"lp-error-banner",children:[e.jsx(K,{size:18}),e.jsx("span",{children:O})]}),j&&e.jsxs("div",{className:"lp-success-banner",children:[e.jsx(d,{size:18}),e.jsx("span",{children:"¡Solicitud enviada correctamente!"})]})]}),e.jsx("div",{className:"lp-modal-footer",children:e.jsx("button",{className:"lp-btn-primary",onClick:se,disabled:R||j,children:R?e.jsx(P,{className:"lp-spin",size:20}):j?e.jsxs(e.Fragment,{children:[e.jsx(d,{size:20})," Enviado"]}):e.jsx(e.Fragment,{children:"Solicitar retiro"})})})]})}),ee&&e.jsx("div",{className:"lp-modal-overlay",onClick:()=>m(!1),children:e.jsxs("div",{className:"lp-modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"lp-modal-header",children:[e.jsx("button",{className:"lp-modal-close",onClick:()=>m(!1),children:e.jsx(G,{size:22})}),e.jsx("div",{className:"lp-modal-icon send",children:e.jsx(u,{size:28})}),e.jsx("h2",{children:"Enviar dinero"}),e.jsx("p",{className:"lp-modal-subtitle",children:"Transfiere fondos a otro usuario de LinkPay"})]}),e.jsxs("div",{className:"lp-modal-body",children:[e.jsxs("div",{className:"lp-field",children:[e.jsx("label",{children:"Destinatario"}),e.jsxs("div",{className:"lp-input-icon-wrapper",children:[e.jsx("input",{type:"email",value:b,onChange:a=>F(a.target.value),placeholder:"email@ejemplo.com",className:"lp-input with-icon"}),e.jsx(u,{size:18,className:"lp-input-icon"})]})]}),e.jsxs("div",{className:"lp-amount-hero",children:[e.jsxs("div",{className:"lp-amount-row",children:[e.jsx("input",{type:"number",inputMode:"decimal",value:k,onChange:a=>_(a.target.value),placeholder:"0",className:"lp-amount-input"}),e.jsx("span",{className:"lp-amount-currency",children:"EUR"})]}),e.jsxs("div",{className:"lp-amount-available",children:["Disponible: ",e.jsxs("strong",{children:[n.toFixed(2)," €"]})]})]}),e.jsxs("div",{className:"lp-field",children:[e.jsxs("label",{children:["Nota ",e.jsx("span",{className:"lp-optional",children:"(opcional)"})]}),e.jsx("input",{type:"text",value:te,onChange:a=>W(a.target.value),placeholder:"Ej: Pago por colaboración",className:"lp-input"})]}),U&&e.jsxs("div",{className:"lp-error-banner",children:[e.jsx(K,{size:18}),e.jsx("span",{children:U})]}),z&&e.jsxs("div",{className:"lp-success-banner",children:[e.jsx(d,{size:18}),e.jsx("span",{children:"¡Dinero enviado correctamente!"})]})]}),e.jsx("div",{className:"lp-modal-footer",children:e.jsx("button",{className:"lp-btn-primary blue",onClick:le,disabled:$||z,children:$?e.jsx(P,{className:"lp-spin",size:20}):z?e.jsxs(e.Fragment,{children:[e.jsx(d,{size:20})," Enviado"]}):e.jsx(e.Fragment,{children:"Enviar ahora"})})})]})})]})}const ye=`
  /* ─── ANIMATIONS ─────────────────────────────────────────────────────────── */
