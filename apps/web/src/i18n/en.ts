export const en = {
    ...
    dashboard: {
        ...
        stats: {
            revenue: {
                label: 'Total Revenue',
                sub: 'Links + Bio, combined',
                links: 'Links',
                bio: 'Bio Page'
            },
            clicks: {
                label: 'Total Clicks',
                sub: 'Real impact of your links'
            },
            referrals: {
    ...
    analytics: {
        ...
        timeline: {
            ...
            badge: 'Last 30 days',
            subtitle: 'Combined activity from all your Smart Links and Bio Page.',
            empty_title: 'Not enough data yet.',
            empty_desc: 'Start sharing your Smart Links to activate analytics.',
            clicks: 'Clicks',
            earnings: 'Earnings'
        },
        locations: {
            title: 'Top Geographies',
            subtitle: 'Countries generating the most clicks.',
            empty: 'No geographic data.',
            clicks: 'Clicks'
        },
        devices: {
            title: 'Devices',
            subtitle: 'Traffic split between mobile, desktop, and others.',
            empty: 'Waiting for traffic...',
            total: 'Total Clicks',
            desktop: 'Desktop',
            mobile: 'Mobile',
            tablet: 'Tablet',
